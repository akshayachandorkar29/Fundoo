...
class UserService:
    ...
    def register(self, user_data, that=None):
        try:
            ...
            if response['success'] == False:
                ...
                message = f"Click here to activate : {protocol}://{host}/activate/?token={short}"
    ...
    def forgot(self, user_data, that=None):
        try:
            response = {
                "success": False,
                "message": "Something went wrong",
            ...
            for record in db_data:
                ...
                if db_email == user_email:
                    ...
                    message = f"Click here to reset the password : {protocol}://{host}/reset/?token=" + short
